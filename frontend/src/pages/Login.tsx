    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex items-center justify-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent text-lg font-bold text-white">E</div>
          <span className="text-xl font-semibold tracking-tight">EduSupport</span>
        </div>
        <form onSubmit={submit} className="rounded-xl border border-black/10 bg-surface p-6">
          ...
          <input
            ...
            required
            className="mb-4 w-full rounded-lg border border-black/15 bg-white px-3 py-2 text-sm outline-none focus:border-accent"
          />
          ...
          <input
            ...
            required
            className="mb-5 w-full rounded-lg border border-black/15 bg-white px-3 py-2 text-sm outline-none focus:border-accent"
          />
          <button
            type="submit"
            disabled={loading}
